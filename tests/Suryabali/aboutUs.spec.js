...
async function about(webApp) {
    ...
    const aboutPath = webApp.locator(`xpath=//a[normalize-space()='Tentang Kami']`);
    await aboutPath.click();
    await expect(webApp.locator(`xpath=//h1[normalize-space()='Tentang Surya Bali']`)).toBeVisible();
}
