...
async function packetRate(webApp) {
    ...
    const packetRatePath = webApp.locator(`xpath=//div[normalize-space()='Masukkan data paket']`);
...
async function pickOrigin(webApp, origin) {
    ...
    const originDropdown = webApp.locator(`xpath=//select[@id='asal']`);
...
async function pickDestination(webApp, destination) {
    ...
    const destinationDropdown = webApp.locator(`xpath=//select[@id='tujuan']`);
...
//     const typeDropdown = webApp.locator(`xpath=//select[@id='jenis']`);
