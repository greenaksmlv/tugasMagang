...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=//span[normalize-space()='INDOMARET 481 CILEUNYI / VIRTUAL POINT']`)).toBeVisible();
    await webApp.locator(`xpath=//span[normalize-space()='INDOMARET 481 CILEUNYI / VIRTUAL POINT']`).click();
...
async function selectDate(webApp, date) {
    ...
    const dateField = webApp.locator(`xpath=//div[@class='col-12 col-lg-12 mx-auto']//form`);
