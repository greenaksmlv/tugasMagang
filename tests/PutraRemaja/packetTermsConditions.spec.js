...
async function packetTermsConditions(webApp) {
    ...
    await webApp.locator(`xpath=//a[normalize-space()='Syarat & Ketentuan Titip Kirim Paket']`).click();
    
    // wait for the detail information to be visible
    await expect(webApp.locator(`xpath=//h1[normalize-space()='Syarat & Ketentuan Paket']`)).toBeVisible();
}
