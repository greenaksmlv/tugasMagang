...
async function packetTracking(webApp) {
    ...
    try {
        await webApp.locator(`xpath=//a[normalize-space()='Paket']`).first().click();
        await webApp.locator(`xpath=//div[normalize-space()='No. Resi']`).click();
        await webApp.locator(`xpath=//input[@id='noresi']`).fill(codeBooking);
