...
async function pickArrival(webApp, arrival) {
    ...
    await expect(webApp.locator(`xpath=//span[normalize-space()='TRANSKITA CILEGON']`)).toBeVisible();
    await webApp.locator(`xpath=//span[normalize-space()='TRANSKITA CILEGON']`).click();
...
// Masalah dibagian pick date, xpathnya not found
...
async function selectDate(webApp, date) {
    ...
    const input = webApp.locator(`xpath=//input[@class='form-control form-pp datepicker flatpickr-input input active']`);
